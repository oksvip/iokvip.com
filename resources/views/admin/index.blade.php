...
<head>
    ...
    <!-- Malihu Scrollbar -->
    <link href="{{ asset('static/admin/vendors/bower_components/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css') }}" rel="stylesheet">

    <!-- Full Calendar -->
    <link href="{{ asset('static/admin/vendors/bower_components/fullcalendar/dist/fullcalendar.min.css') }}" rel="stylesheet">

    <!-- Site CSS -->
    <link href="{{ asset('static/admin/css/app-1.min.css') }}" rel="stylesheet">

    <!-- Page loader -->
    <script src="{{ asset('static/admin/js/page-loader.min.js') }}"></script>
</head>
...
<header id="header">
    ...
    <div class="logo">
        <a href="{{ route('admin.home') }}" class="hidden-xs">
            Material
    ...
    <ul class="top-menu">
        ...
        <li class="top-menu__profile dropdown">
            <a data-toggle="dropdown" href="">
                <img src="{{ asset('static/admin/demo/img/profile-pics/1.jpg') }}" alt="">
            </a>
            ...
            <ul class="dropdown-menu pull-right dropdown-menu--icon">
                ...
                <li>
                    <a href="javascript:" onclick="logout()"><i class="zmdi zmdi-time-restore"></i> 退出</a>
                    <form action="{{ route('admin.logout', [\Auth::user()]) }}" method="post" id="logout">
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
                    </form>
                </li>
            ...
            <div class="tab-pane" id="notifications__messages">
                <div class="list-group">
                    <a href="" class="list-group-item media">
                        <div class="pull-left">
                            <img class="avatar-img" src="{{ asset('static/admin/demo/img/profile-pics/1.jpg') }}" alt="">
                        </div>
                    ...
                    <a href="" class="list-group-item media">
                        <div class="pull-left">
                            <img class="avatar-img" src="{{ asset('static/admin/demo/img/profile-pics/5.jpg') }}" alt="">
                        </div>
                        <div class="media-body">
                    ...
                    <a href="" class="list-group-item media">
                        <div class="pull-left">
                            <img class="avatar-img" src="{{ asset('static/admin/demo/img/profile-pics/3.jpg') }}" alt="">
                        </div>
                        <div class="media-body">
                    ...
                    <a href="" class="list-group-item media">
                        <div class="pull-left">
                            <img class="avatar-img" src="{{ asset('static/admin/demo/img/profile-pics/4.jpg') }}" alt="">
                        </div>
                        <div class="media-body">
                    ...
                    <a href="" class="list-group-item media">
                        <div class="pull-left">
                            <img class="avatar-img" src="{{ asset('static/admin/demo/img/profile-pics/2.jpg') }}" alt="">
                        </div>
                        <div class="media-body">
        ...
        <div id="content__grid" data-columns>
            ...
            <div class="card widget-recent-signups">
                ...
                <div class="card__body widget-recent-signups__list">
                    ...
                    <a href=""><img class="avatar-img" src="{{ asset('static/admin/demo/img/profile-pics/5.jpg') }}" alt=""></a>
                    <a href=""><div class="avatar-char">L</div></a>
                    <a href=""><div class="avatar-char">A</div></a>
                    <a href=""><img class="avatar-img" src="{{ asset('static/admin/demo/img/profile-pics/4.jpg') }}" alt=""></a>
                    ...
                    <a href=""><img class="avatar-img" src="{{ asset('static/admin/demo/img/profile-pics/3.jpg') }}" alt=""></a>
                    <a href=""><div class="avatar-char">A</div></a>
                    <a href=""><img class="avatar-img" src="{{ asset('static/admin/demo/img/profile-pics/9.jpg') }}" alt=""></a>
                    <a href=""><div class="avatar-char">N</div></a>
                    <a href=""><div class="avatar-char">X</div></a>
                    <a href=""><div class="avatar-char">V</div></a>
                    <a href=""><img class="avatar-img" src="{{ asset('static/admin/demo/img/profile-pics/7.jpg') }}" alt=""></a>
                    <a href=""><img class="avatar-img" src="{{ asset('static/admin/demo/img/profile-pics/6.jpg') }}" alt=""></a>
                    <a href=""><img class="avatar-img" src="{{ asset('static/admin/demo/img/profile-pics/8.jpg') }}" alt=""></a>
            ...
            <div class="card">
                <div class="card__header card__header--img" style="background-image: url({{ asset('static/admin/demo/img/note.png') }}); height: 250px;"></div>
                <div class="card__header">
                    <h2>
...
<!-- Malihu ScrollBar -->
<script src="{{ asset('static/admin/vendors/bower_components/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js') }}"></script>

<!-- Bootstrap Notify -->
<script src="{{ asset('static/admin/vendors/bower_components/remarkable-bootstrap-notify/dist/bootstrap-notify.min.js') }}"></script>

<!-- Moment -->
<script src="{{ asset('static/admin/vendors/bower_components/moment/min/moment.min.js') }}"></script>

<!-- FullCalendar -->
<script src="{{ asset('static/admin/vendors/bower_components/fullcalendar/dist/fullcalendar.min.js') }}"></script>

<!-- Simple Weather -->
<script src="{{ asset('static/admin/vendors/bower_components/simpleWeather/jquery.simpleWeather.min.js') }}"></script>

<!-- Salvattore -->
<script src="{{ asset('static/admin/vendors/bower_components/salvattore/dist/salvattore.min.js') }}"></script>

<!-- Flot Charts -->
<script src="{{ asset('static/admin/vendors/bower_components/flot/jquery.flot.js') }}"></script>
<script src="{{ asset('static/admin/vendors/bower_components/flot/jquery.flot.resize.js') }}"></script>
<script src="{{ asset('static/admin/vendors/bower_components/flot.curvedlines/curvedLines.js') }}"></script>

<!-- Sparkline Charts -->
<script src="{{ asset('static/admin/vendors/jquery.sparkline/jquery.sparkline.min.js') }}"></script>

<!-- EasyPie Charts -->
<script src="{{ asset('static/admin/vendors/bower_components/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js') }}"></script>
...
<!-- Demo Only -->
<script src="{{ asset('static/admin/demo/js/flot-charts/curved-line.js') }}"></script>
<script src="{{ asset('static/admin/demo/js/flot-charts/line.js') }}"></script>
<script src="{{ asset('static/admin/demo/js/easy-pie-charts.js') }}"></script>
<script src="{{ asset('static/admin/demo/js/misc.js') }}"></script>
<script src="{{ asset('static/admin/demo/js/sparkline-charts.js') }}"></script>
<script src="{{ asset('static/admin/demo/js/calendar.js') }}"></script>
